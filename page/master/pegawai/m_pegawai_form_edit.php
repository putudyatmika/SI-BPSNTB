...
<div class="col-lg-12 col-sm-12">
		...
		<div class="form-group">
			<label for="pegawai_tgl_lahir" class="col-sm-3 control-label">Tanggal Lahir</label>
				<div class="col-sm-3">
				<div class="input-group margin-bottom-sm">
					<input type="text" name="pegawai_tgl_lahir" id="pegawai_tgl_lahir" value="<?php echo $r->pegawai_tgl_lahir;?>" readonly="readonly" class="form-control" placeholder="Tanggal Lahir"/>
