<div class="col-lg-12 col-sm-12">
		...
		<div class="form-group">
			<label for="pegawai_nip" class="col-sm-2 control-label">NIP</label>
		...
		<div class="form-group">
			<label for="pegawai_nama" class="col-sm-2 control-label">Nama Lengkap</label>
		...
		<div class="form-group">
			<label for="pegawai_nama" class="col-sm-2 control-label">Nama Panggilan</label>
		...
		<div class="form-group">
			<label for="pegawai_nip_lama" class="col-sm-2 control-label">NIP Lama</label>
		...
		<div class="form-group">
			<label for="pegawai_agama" class="col-sm-2 control-label">Agama</label>
		...
		<div class="form-group">
			<label for="pegawai_jk" class="col-sm-2 control-label">Jenis Kelamin</label>
		...
		<div class="form-group">
			<label for="pegawai_nama" class="col-sm-2 control-label">Tempat Lahir</label>
		...
		<div class="form-group">
			<label for="pegawai_tgl_lahir" class="col-sm-2 control-label">Tanggal Lahir</label>
				<div class="col-sm-3">
				<div class="input-group margin-bottom-sm">
					<input type="text" name="pegawai_tgl_lahir" id="pegawai_tgl_lahir" readonly="readonly" class="form-control" placeholder="Tanggal Lahir"/>
					<span class="input-group-addon date" id="tanggal" style="cursor:pointer;"><i class="fa fa-calendar fa-fw"></i></span>
					</div>
				</div>
		</div>
		<div class="form-group">
			<label for="pegawai_tmt_cpns" class="col-sm-2 control-label">TMT CPNS</label>
				<div class="col-sm-3">
				<div class="input-group margin-bottom-sm">
		...
		<div class="form-group">
			<label for="pegawai_tmt_pns" class="col-sm-2 control-label">TMT PNS</label>
				<div class="col-sm-3">
				<div class="input-group margin-bottom-sm">
		...
		<div class="form-group">
			<label for="pegawai_unit" class="col-sm-2 control-label">Unit Kerja</label>
