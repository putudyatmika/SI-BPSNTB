...
if ($_POST['submit_update']) {
	...
	if ($cek>0) {
		 if ($ganti_passwd==1) {
			$sql_users_save = $conn -> query("update users set user_id='$user_id',user_diupdate_oleh='$created',user_unit='$user_unit',user_status='$user_status',user_diupdate_waktu='$waktu_lokal',user_level='$user_level' where user_nip='$user_nip'");
		 }
		 else {
			 $sql_users_save = $conn -> query("update users set user_id='$user_id',user_diupdate_oleh='$created',user_unit='$user_unit',user_status='$user_status',user_diupdate_waktu='$waktu_lokal',user_level='$user_level',user_passwd='$user_passwd' where user_nip='$user_nip'");
		 }
